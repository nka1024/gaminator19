...
export class Dialogs {
  ...
  public static sphereStart: DialogLine[] = [
    ...
    { a: DialogActorID.Controller, m: '- Мы не считаем, что ситуацию в секторе представляет угрозу для Такхона. Напротив, наш эксперементы по протогенезу имели большой успех - центральная в курсе наших действий в этом секторе. Она на нашей стороне. Хи-хи.' },
    ...
    { a: DialogActorID.Controller, m: '- Как видишь, твой друг уже пользуется результатами наших исследовний. Протонный синтех значительно расширит кибернетические возможности всего экипажа. Нам нужно еще не больше полусотни эксперементов. А вы двое как раз подходящие образцы. Особенно, ты, синеволосый.' },
  ...
  public static sphereVictory: DialogLine[] = [
    ...
    { a: DialogActorID.Unknown, m: 'В появилось небольшое углубление и появился разъем нейроинтерфейса.'},
    {
