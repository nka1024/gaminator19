...
export class AssetsLoader {
  public static preload(scene: Phaser.Scene) {
    ...
    scene.load.spritesheet("cursor_spot_red_68x70", "./assets/board/cursor_spot_red_68x70.png", { frameWidth: 68, frameHeight: 70 });
    ...
    scene.load.spritesheet('jellyfish_64x64', './assets/gaminator/jellyfish_64x64.png', { frameWidth: 64, frameHeight: 64 });
    ...
    scene.load.image("skill_sleeper_hold", "./assets/board/skills/skill_sleeper_hold.png");
    ...
    scene.load.image("creature_injection", "./assets/board/creatures/injection.png");
    ...
    scene.load.image("spell_enrage", "./assets/board/creatures/enrage.png");
